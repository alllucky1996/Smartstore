...
namespace JAN.Sizing.Providers
{
    [SystemName("JAN.Sizing.ProductCsv")]
    [FriendlyName("Domain Tutorial CSV product feed")]
    [ExportFeatures(Features =
        ExportFeatures.CreatesInitialPublicDeployment |
        ExportFeatures.OffersBrandFallback)]
    public class DomainTutorialCsvExportProvider : ExportProviderBase
    {
        public static string SystemName => "JAN.Sizing.ProductCsv";
        ...
        {
            ConfigurationWidget = new ComponentWidget<DomainTutorialConfigurationViewComponent>(),
