...
{
    [SystemName("JAN.Sizing.ProductXml")]
    [FriendlyName("Domain Tutorial XML product feed")]
    [ExportFeatures(Features =
        ExportFeatures.CreatesInitialPublicDeployment |
        ExportFeatures.OffersBrandFallback)]
    public class DomainTutorialXmlExportProvider : ExportProviderBase
    {
        public static string SystemName => "JAN.Sizing.ProductXml";
